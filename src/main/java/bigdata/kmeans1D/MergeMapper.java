...
public class MergeMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		try {
			...
			for (IntWritable p : center.keySet()) {
				...
				Double distance = Kmeans1D.measureDistance(tmp_point.get(),
						point);
			...
			context.write(best_pivot, value);
		} catch (Exception e) {
